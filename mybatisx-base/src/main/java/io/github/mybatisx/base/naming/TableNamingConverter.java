 ...
 * @since 1.0.0
 */
public class TableNamingConverter extends AbstractNamingConverter {

    public TableNamingConverter(NamingStrategy targetStrategy) {
        this(NamingStrategy.UPPER_CAMEL, targetStrategy);
    }
