...
public class GenericForeignImplementor<T> extends AbstractGenericJoinable<T, GenericForeignImplementor<T>> {

    private static final long serialVersionUID = -7121565099334266391L;

    public GenericForeignImplementor(Query<?> reference, Class<T> entity, Join join) {
        this(reference, entity, null, join);
    }

    public GenericForeignImplementor(Query<?> reference, Class<T> entity, String alias, Join join) {
    ...
    /**
     * 创建{@link GenericForeignImplementor}对象
     *
     * @param reference {@link Query}
     * @param entity    实体类
     * @param join      {@link Join}
     * @param <S>       实体类型
     * @return {@link GenericForeignImplementor}
     */
    public static <S> GenericForeignImplementor<S> from(final Query<?> reference, final Class<S> entity,
                                                        final Join join) {
    ...
    public static <S> GenericForeignImplementor<S> from(final Query<?> reference, final Class<S> entity,
        ...
        return from(reference, entity, alias, join, (Consumer<GenericForeignImplementor<S>>) null);
    }
     ...
     * @return {@link GenericForeignImplementor}
     */
    public static <S> GenericForeignImplementor<S> from(final Query<?> reference, final Class<S> entity, final Join join,
    ...
    public static <S> GenericForeignImplementor<S> from(final Query<?> reference, final Class<S> entity,
                                                        final String alias, final Join join,
                                                        final Consumer<GenericForeignImplementor<S>> onConsumer) {
        final GenericForeignImplementor<S> it = new GenericForeignImplementor<>(reference, entity, alias, join);
        if (onConsumer != null) {
     ...
     * @return {@link GenericForeignImplementor}
     */
    public static <S, T, R extends Query<T>> GenericForeignImplementor<S> from(final R reference, final Class<S> entity, final Join join,
                                                                               final BiConsumer<GenericForeignImplementor<S>, R> onConsumer) {
        return from(reference, entity, null, join, onConsumer);
    }
     ...
     * @return {@link GenericForeignImplementor}
     */
    public static <S, T, R extends Query<T>> GenericForeignImplementor<S> from(final R reference, final Class<S> entity,
                                                                               final String alias, final Join join,
                                                                               final BiConsumer<GenericForeignImplementor<S>, R> onConsumer) {
        final GenericForeignImplementor<S> it = new GenericForeignImplementor<>(reference, entity, alias, join);
        if (onConsumer != null) {
