...
public final class ReservedKeywordRegistry {
     ...
     * 关键词缓存
     */
    private static final Set<String> RESERVED_KEYWORD_CACHE;
    ...
    static {
        ...
        RESERVED_KEYWORD_CACHE = new HashSet<>(words.length + 10);
        RESERVED_KEYWORD_CACHE.addAll(Arrays.asList(words));
    }
