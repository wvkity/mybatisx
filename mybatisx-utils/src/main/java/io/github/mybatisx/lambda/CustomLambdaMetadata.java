...
public class CustomLambdaMetadata implements LambdaMetadata {
    ...
    public Class<?> getImplClass() {
        ...
        try {
            return Reflections.loadClass(implType, this.serializedLambda.getCapturingClass().getClassLoader());
        } catch (Exception e) {
