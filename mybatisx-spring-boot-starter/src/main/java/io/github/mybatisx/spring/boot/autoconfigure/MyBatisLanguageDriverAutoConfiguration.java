...
/**
 * copy from {@code org.mybatis.spring.boot.autoconfigure.MybatisLanguageDriverAutoConfiguration}
 *
 * @author wvkity
 * @created 2021/12/25
 * @since 1.0.0
...
public class MyBatisLanguageDriverAutoConfiguration {
    ...
    private static final String CONFIGURATION_PROPERTY_PREFIX = "mybatisx.scripting-language-driver";
